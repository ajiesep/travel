                    ...
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <p class="disclaimer mb-0">
                                You are only able to invite member that has registered in ajiesepTour.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                ...
                                <span class="text-blue">$ {{ $item->transaction_total }},</span><span class="text-orang">{{ mt_rand(0,99) }}</span>
                                </td>
                            </tr>
                        </table>
                        <hr>
